...
var _marked =
/*#__PURE__*/
regeneratorRuntime.mark(clockAsync);

// thunk
var thunkify = __webpack_require__(334);
...
var thunkTick = thunkify(Tick);
var thunkTock = thunkify(Tock);
/**
 * generator函数
 */
...
function clockAsync() {
  var n,
      _args = arguments;
  return regeneratorRuntime.wrap(function clockAsync$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 1:
          ...
          _context.next = 4;
          return thunkTick(1000);

        case 4:
          _context.next = 6;
          return thunkTock(1000);
...
module.exports = function thunkify(fn) {
  return function () {
    ...
    var ctx = this; // console.log("arguments");
    // console.log(arguments);

    var args = Array.prototype.slice.call(arguments); // console.log("args = ");
    // console.log(args);

    return function (callback) {
      var called; // 内部添加一个callback

      args.push(function () {
        if (called) return;
        called = true; // console.log("--in thunkify callback method--");
